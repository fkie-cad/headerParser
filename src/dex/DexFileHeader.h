...
static const uint8_t MAGIC_DEX_BYTES_LN = 4;
static const uint8_t DEX_FILE_HEADER_SIZE = 112;
static const uint32_t DEX_ENDIAN_CONSTANT = 0x12345678;
static const uint32_t DEX_REVERSE_ENDIAN_CONSTANT = 0x78563412;
...
const uint8_t DEX_SIZE_OF_STRING_ID_ITEM = sizeof(DexStringIdItem);
...
const uint8_t DEX_SIZE_OF_TYPE_ID_ITEM = sizeof(DexTypeIdItem);
...
const uint8_t DEX_SIZE_OF_PROTO_ID_ITEM = sizeof(DexProtoIdItem);
...
const uint8_t DEX_SIZE_OF_FIELD_ID_ITEM = sizeof(DexFieldIdItem);
...
const uint8_t DEX_SIZE_OF_METHOD_ID_ITEM = sizeof(DexMethodIdItem);
...
const uint8_t DEX_SIZE_OF_CLASS_DEF_ITEM = sizeof(DexClassDefItem);
...
//const uint8_t DEX_SIZE_OF_CLASS_DATA_ITEM = sizeof(DexClassDataItem);
...
const uint8_t DEX_SIZE_OF_MAP_ITEM = sizeof(DexMapItem);
