...
#define MIN_SIZE_OF_ZIP_RECORD (0x1e)
#define MIN_SIZE_OF_ZIP_DIR_ENTRY (0x2e)
#define MIN_SIZE_OF_ZIP_END_LOCATOR (0x16)
#define SIZE_OF_ZIP_DATA_DESCRIPTION (0x10)

#define ZIP_VS_1_0 (0x0a)
#define ZIP_VS_2_0 (0x14)
