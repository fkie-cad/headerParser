...
//	{ {IMAGE_FILE_MACHINE_TARGET_HOST, "Interacts with the host and not a WOW64 guest"}, XX, 32 },
	{ {IMAGE_FILE_MACHINE_ALPHA, "DEC Alpha AXP"}, ARCH_ALPHA, 32 },
	...
	{ {IMAGE_FILE_MACHINE_DEC_ALPHA_AXP, "DEC Alpha AXP 32"}, ARCH_ALPHA, 32 },
...
ArchitectureMapEntry elf_arch_id_mapper[] = {
	...
	{ {EM_RH32, "TRW RH-32"}, ARCH_TRW, 0 },
	{ {EM_RCE, "Motorola RCE"}, ARCH_MOTOROLA, 0 },
	{ {EM_ARM, "Advanced RISC Machines ARM"}, ARCH_ARM, 32},
	{ {EM_ALPHA, "Digital Alpha"}, ARCH_ALPHA, 0 },
	{ {EM_SH, "Hitachi SH"}, ARCH_HITACHI, 0 },
	{ {EM_SPARCV9, "SPARC Version 9"}, ARCH_SPARC, 0 },
	{ {EM_TRICORE, "Siemens TriCore embedded processor"}, ARCH_SIEMENS, 0 },
	{ {EM_ARC, "Argonaut RISC Core, Argonaut Technologies Inc."}, ARCH_RISC, 32 },
	{ {EM_H8_300, "Hitachi H8/300"}, ARCH_HITACHI, 0 },
	{ {EM_H8_300H, "Hitachi H8/300H"}, ARCH_HITACHI, 0 },
	{ {EM_H8S, "Hitachi H8S"}, ARCH_HITACHI, 0 },
	{ {EM_H8_500, "Hitachi H8/500"}, ARCH_HITACHI, 0 },
	{ {EM_IA_64, "Intel IA-64 processor architecture"}, ARCH_INTEL, 64 },
	{ {EM_MIPS_X, "Stanford MIPS-X"}, ARCH_MIPS, 0 },
	{ {EM_COLDFIRE, "Motorola ColdFire"}, ARCH_MOTOROLA, 0 },
	{ {EM_68HC12, "Motorola M68HC12"}, ARCH_MOTOROLA, 0 },
	...
	{ {EM_STARCORE, "Motorola Star*Core processor"}, ARCH_MOTOROLA, 0 },
	{ {EM_ME16, "Toyota ME16 processor"}, ARCH_TOYOTA, 0 },
	{ {EM_ST100, "STMicroelectronics ST100 processor"}, ARCH_STM, 0 },
	{ {EM_TINYJ, "Advanced Logic Corp. TinyJ embedded processor family"}, ARCH_ALC, 0 },
	{ {EM_X86_64, "AMD x86-64 architecture"}, ARCH_INTEL, 64 },
	{ {EM_PDSP, "Sony DSP Processor"}, ARCH_SONY, 0 },
	{ {EM_PDP10, "Digital Equipment Corp. PDP-10"}, ARCH_DEC, 0 },
	{ {EM_PDP11, "Digital Equipment Corp. PDP-11"}, ARCH_DEC, 0 },
	...
	{ {EM_VAX, "Digital VAX"}, ARCH_DVAX, 0 },
	...
	{ {EM_FR30, "Fujitsu FR30"}, ARCH_FUJITSU, 0 },
...
//		{ {EM_V850, "NEC v850"}, ARCH_xx, 0 },
	...
	{ {EM_PJ, "picoJava"}, ARCH_PICO_JAVA, 0 },
	...
	{ {EM_TMM_GPP, "Thompson Multimedia General Purpose Processor"}, ARCH_THOMPSON, 0 },
	{ {EM_NS32K, "National Semiconductor 32000 series"}, ARCH_NS, 0 },
	...
	{ {EM_IP2K, "Ubicom IP2xxx microcontroller family"}, ARCH_UBICOM, 0 },
	{ {EM_MAX, "MAX Processor"}, ARCH_MAX, 0 },
	{ {EM_CR, "National Semiconductor CompactRISC microprocessor"}, ARCH_NS, 0 },
	{ {EM_F2MC16, "Fujitsu F2MC16"}, ARCH_FUJITSU, 0 },
	{ {EM_MSP430, "Texas Instruments embedded microcontroller msp430"}, ARCH_TI, 0 },
	{ {EM_BLACKFIN, "Analog Devices Blackfin (DSP) processor"}, ARCH_BLACKFIN, 0 },
	{ {EM_SE_C33, "S1C33 Family of Seiko Epson processors"}, ARCH_EPSON, 0 },
	{ {EM_SEP, "Sharp embedded microprocessor"}, ARCH_SHARP, 0 },
	{ {EM_ARCA, "Arca RISC Microprocessor"}, ARCH_RISC, 0 },
	...
	{ {EM_ALTERA_NIOS2, "Altera Nios II soft-core processor"}, ARCH_ALTERA, 0 },
	{ {EM_CRX, "National Semiconductor CompactRISC CRX microprocessor"}, ARCH_NS, 0 },
	{ {EM_XGATE, "Motorola XGATE embedded processor"}, ARCH_MOTOROLA, 0 },
	{ {EM_C166, "Infineon C16x/XC16x processor"}, ARCH_INFINEON, 0 },
	{ {EM_M16C, "Renesas M16C series microprocessors"}, ARCH_RENESAS, 0 },
	{ {EM_DSPIC30F, "Microchip Technology dsPIC30F Digital Signal Controller"}, ARCH_MT, 0 },
	{ {EM_CE, "Freescale Communication Engine RISC core"}, ARCH_RISC, 0 },
	{ {EM_M32C, "Renesas M32C series microprocessors"}, ARCH_RENESAS, 0 },
	{ {EM_TSK3000, "Altium TSK3000 core"}, ARCH_ALTIUM, 0 },
	{ {EM_RS08, "Freescale RS08 embedded 77processor"}, ARCH_FREESCALE, 0 },
	{ {EM_SHARC, "Analog Devices SHARC family of 32-bit DSP processors"}, ARCH_BLACKFIN, 32 },
	{ {EM_ECOG2, "Cyan Technology eCOG2 microprocessor"}, ARCH_CYAN, 0 },
	{ {EM_SCORE7, "Sunplus S+core7 RISC processor"}, ARCH_RISC, 0 },
	{ {EM_DSP24, "New Japan Radio (NJR) 24-bit DSP Processor"}, ARCH_NJR, 24 },
	{ {EM_VIDEOCORE3, "Broadcom VideoCore III processor"}, ARCH_BROADCOM, 0 },
	{ {EM_LATTICEMICO32, "RISC processor for Lattice FPGA architecture"}, ARCH_RISC, 0 },
	{ {EM_SE_C17, "Seiko Epson C17 family"}, ARCH_EPSON, 0 },
	{ {EM_TI_C6000, "The Texas Instruments TMS320C6000 DSP family"}, ARCH_TI, 0 },
	{ {EM_TI_C2000, "The Texas Instruments TMS320C2000 DSP family"}, ARCH_TI, 0 },
	{ {EM_TI_C5500, "The Texas Instruments TMS320C55x DSP family"}, ARCH_TI, 0 },
	{ {EM_TI_ARP32, "Texas Instruments Application Specific RISC Processor, 32bit fetch"}, ARCH_RISC, 0 },
	{ {EM_TI_PRU, "Texas Instruments Programmable Realtime Unit"}, ARCH_TI, 0 },
	{ {EM_MMDSP_PLUS, "STMicroelectronics 64bit VLIW Data Signal Processor"}, ARCH_STM, 64 },
	{ {EM_CYPRESS_M8C, "Cypress M8C microprocessor"}, ARCH_CYPRESS, 0 },
	{ {EM_R32C, "Renesas R32C series microprocessors"}, ARCH_RENESAS, 0 },
	{ {EM_TRIMEDIA, "NXP Semiconductors TriMedia architecture family"}, ARCH_NXP, 0 },
	{ {EM_QDSP6, "QUALCOMM DSP6 Processor"}, ARCH_QUALCOMM, 0 },
	{ {EM_8051, "Intel 8051 and variants"}, ARCH_INTEL, 0 },
	{ {EM_STXP7X, "STMicroelectronics STxP7x family of configurable and extensible RISC processors"}, ARCH_RISC, 0 },
	{ {EM_NDS32, "Andes Technology compact code size embedded RISC processor family"}, ARCH_RISC, 0 },
	{ {EM_ECOG1, "Cyan Technology eCOG1X family"}, ARCH_CYAN, 0 },
//	{ {EM_ECOG1X, "Cyan Technology eCOG1X family"}, ARCH_xx, 0 },
	{ {EM_MAXQ30, "Dallas Semiconductor MAXQ30 Core Micro-controll"}, ARCH_DALLAS, 0 },
	...
	{ {EM_CRAYNV2, "Cray Inc. NV2 vector architecture"}, ARCH_CRACY, 0 },
	{ {EM_RX, "Renesas RX family"}, ARCH_RENESAS, 0 },
	{ {EM_METAG, "Imagination Technologies META processor architecture"}, ARCH_IMAGINATION, 0 },
	{ {EM_MCST_ELBRUS, "MCST Elbrus general purpose hardware architecture"}, ARCH_MCST, 0 },
	{ {EM_ECOG16, "Cyan Technology eCOG16 family"}, ARCH_CYAN, 0 },
	...
	{ {EM_SLE9X, "Infineon Technologies SLE9X core"}, ARCH_INFINEON, 0 },
	...
	{ {EM_RL78, "Renesas RL78 family"}, ARCH_RENESAS, 0 },
	{ {EM_VIDEOCORE5, "Broadcom VideoCore V processor"}, ARCH_BROADCOM, 0 },
	{ {EM_78KOR, "Renesas 78KOR family"}, ARCH_RENESAS, 0 },
