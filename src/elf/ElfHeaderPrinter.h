...
static void Elf_printFileHeader(Elf64FileHeader* fh, size_t start_file_offset);
...
static void Elf_printProgramHeaderTableEntry(Elf64ProgramHeader* ph, uint16_t idx, uint16_t e_phnum, size_t offset, uint8_t bitness);
...
void Elf_printProgramHeaderTableEntry(Elf64ProgramHeader* ph, uint16_t idx, uint16_t e_phnum, size_t offset, uint8_t bitness)
{
...
void
Elf_printSectionHeaderTableEntry(Elf64SectionHeader* sh, uint16_t idx, uint16_t e_shnum, char* name, size_t offset, uint8_t bitness)
{
